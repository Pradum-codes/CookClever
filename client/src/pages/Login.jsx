...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('User stored in context, localStorage user:', localStorage.getItem('user')); // Debug log
        ...
        <Card className="w-full max-w-md relative z-10 shadow-2xl border-0 bg-white/80 backdrop-blur-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <label className="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" className="rounded border-gray-300 focus:ring-orange-500" />
